...
DEFAULT_HABITS = [
    ...
    {'name': 'Јадов здрава храна', 'category': 'Физичко здравје', 'icon': '🥗'},
    {'name': 'Медитирав/се релаксирав', 'category': 'Ментално здравје', 'icon': '🧘'},
    {'name': 'Читав книга/едукативен материјал', 'category': 'Лично развитие', 'icon': '📚'},
    {'name': 'Се дружев со пријатели/семејство', 'category': 'Социјални', 'icon': '👥'},
    {'name': 'Работев на хоби', 'category': 'Креативност', 'icon': '🎨'},
    {'name': 'Се излегов надвор/во природа', 'category': 'Благосостојба', 'icon': '🌳'},
    ...
    {'name': 'Напишав во дневник', 'category': 'Самореflексија', 'icon': '📝'},
    {'name': 'Слушнав музика која ме опушта', 'category': 'Благосостојба', 'icon': '🎵'},
    {'name': 'Помогнав на некого', 'category': 'Доброволство', 'icon': '🤝'},
